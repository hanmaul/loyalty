            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                <form action="#">
                    ...
                    <div>
                        ...
                        <select @change="[model.tipe = null, model.dana = null, model.tenor = null, model.cicilan = null]"
                    ...
                    <div>
                        <label for="dana" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dana</label>
